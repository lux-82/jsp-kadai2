...
<body>
    ...
    <ul>
    <li><input type="text" name="year" value="${year}" /><label for="year">年
    </label><input type="text" name="month" value="${month}" /><label for="month">月</label><input type="text" name="day" value="${day}" /><label for="day">日</label></li>
